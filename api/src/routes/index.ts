...
const models: TsoaRoute.Models = {
  ...
  MoveDTO: {
    ...
    properties: {
      ...
      figure: { dataType: "string", required: true },
...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function AuthenticationController_authenticate(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.get(
    ...
    async function MoveController_getAllMoves(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
